...
export const FilterCard  = ({data, index, category, setCategory}) =>{
    return (
        ...
        <motion.div 
         ...
         className={`group w-40 min-w-[128px] cursor-pointer rounded-md py-6 ${category === data.category ? "bg-red-500" : "bg-primary"} hover:bg-red-50 shadow-md flex flex-col items-center justify-center gap-4`}
           >
         <div className={`w10 h-10 rounded-full shadow-md flex items-center justify-center group-hover:bg-primary ${category === data.category ? "bg-primary" : "bg-red-500"}`}>
          <IoFastFood 
