        ...
        <div className='flex flex-col items-start justify-start gap-6'>
            <div className='px-4 py-1 flex items-center justify-center gap-2 bg-orange-100 rounded-full'>
                <p className='text-lg font-semibold text-orange-500'>
                    Free Delivery</p>
                <div className='h-10 w-10 flex items-center justify-center rounded-full bg-primary shadow-md'>
                <img src={Delivery} alt="" className='w-full h-full object-contain'
                />
                </div>
            </div>

            <p className='text-[40px] text-headingColor md:text-[72] font-sans font-extrabold tracking-wider'>
                The fastest delivery in 
                <span className='text-orange-600'> Your City</span>
            </p>

            <p className='text-textColor text-lg'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque finibus est purus, et volutpat purus tristique ac. Cras vehicula, ipsum ut vulputate scelerisque, ex enim iaculis arcu, vulputate condimentum enim lorem nec velit. Cras eu tincidunt 
            </p>
            <motion.button 
             {...buttonClick}
        ...
        {randomData && randomData.map((data, i) => (
            ...
            className='w-32 h-36 md:h-auto md:w-190 p-4 bg-lightOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg'
                ...
                <img 
                    ...
                    className='w-12 h-12 md:w-32 md:h32 md:-mt-16 object-contain' 
                    />
                ...
                <p className='text-sm font-semibold capitalize text-headingColor'>
